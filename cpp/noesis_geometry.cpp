...
// Drop calls dm_noesis_base_component_release; assigning a finished geometry to a
...
extern "C" bool dm_noesis_geometry_get_bounds(void* geometry, float out[4]) {
...
extern "C" bool dm_noesis_geometry_get_render_bounds(void* geometry, float out[4]) {
    auto* g = cast<Noesis::Geometry>(geometry);
    if (!g || !out) return false;
...
extern "C" int32_t dm_noesis_geometry_is_empty(void* geometry) {
    auto* g = cast<Noesis::Geometry>(geometry);
    if (!g) return -1;
    return g->IsEmpty() ? 1 : 0;
}

extern "C" bool dm_noesis_geometry_set_transform(void* geometry, void* transform) {
    auto* g = cast<Noesis::Geometry>(geometry);
    if (!g) return false;
...
extern "C" void* dm_noesis_geometry_get_transform(void* geometry) {
    auto* g = cast<Noesis::Geometry>(geometry);
    if (!g) return nullptr;
...
extern "C" void* dm_noesis_stream_geometry_create(void) {
    Noesis::Ptr<Noesis::StreamGeometry> g = *new Noesis::StreamGeometry();
    return handout(g.GetPtr());
}

extern "C" void* dm_noesis_stream_geometry_create_from_data(const char* data) {
    Noesis::Ptr<Noesis::StreamGeometry> g =
        data ? *new Noesis::StreamGeometry(data) : *new Noesis::StreamGeometry();
    return handout(g.GetPtr());
}

extern "C" bool dm_noesis_stream_geometry_set_data(void* geometry, const char* data) {
...
extern "C" bool dm_noesis_stream_geometry_set_fill_rule(void* geometry, int32_t rule) {
    auto* g = cast<Noesis::StreamGeometry>(geometry);
    if (!g) return false;
...
extern "C" int32_t dm_noesis_stream_geometry_get_fill_rule(void* geometry) {
    auto* g = cast<Noesis::StreamGeometry>(geometry);
    if (!g) return -1;
...
extern "C" void* dm_noesis_stream_geometry_open(void* geometry) {
    auto* g = cast<Noesis::StreamGeometry>(geometry);
    if (!g) return nullptr;
    return new Noesis::StreamGeometryContext(g->Open());
}

extern "C" bool dm_noesis_stream_geometry_context_begin_figure(void* ctx, float x, float y,
                                                               bool is_closed) {
    if (!ctx) return false;
...
extern "C" bool dm_noesis_stream_geometry_context_line_to(void* ctx, float x, float y) {
    if (!ctx) return false;
    static_cast<Noesis::StreamGeometryContext*>(ctx)->LineTo(Noesis::Point(x, y));
    return true;
}

extern "C" bool dm_noesis_stream_geometry_context_cubic_to(void* ctx, float x1, float y1, float x2,
...
extern "C" bool dm_noesis_stream_geometry_context_quadratic_to(void* ctx, float x1, float y1,
                                                               float x2, float y2) {
    if (!ctx) return false;
...
extern "C" bool dm_noesis_stream_geometry_context_arc_to(void* ctx, float x, float y, float width,
...
extern "C" bool dm_noesis_stream_geometry_context_set_is_closed(void* ctx, bool is_closed) {
    if (!ctx) return false;
    static_cast<Noesis::StreamGeometryContext*>(ctx)->SetIsClosed(is_closed);
    return true;
}

extern "C" bool dm_noesis_stream_geometry_context_close(void* ctx) {
    if (!ctx) return false;
...
extern "C" void dm_noesis_stream_geometry_context_destroy(void* ctx) {
    delete static_cast<Noesis::StreamGeometryContext*>(ctx);
}

// ── PathGeometry + PathFigure ────────────────────────────────────────────────

extern "C" void* dm_noesis_path_geometry_create(void) {
...
extern "C" bool dm_noesis_path_geometry_set_fill_rule(void* geometry, int32_t rule) {
...
extern "C" int32_t dm_noesis_path_geometry_get_fill_rule(void* geometry) {
    auto* g = cast<Noesis::PathGeometry>(geometry);
    if (!g) return -1;
    return static_cast<int32_t>(g->GetFillRule());
}

extern "C" int32_t dm_noesis_path_geometry_add_figure(void* geometry, void* figure) {
    auto* g = cast<Noesis::PathGeometry>(geometry);
...
extern "C" int32_t dm_noesis_path_geometry_figure_count(void* geometry) {
    auto* g = cast<Noesis::PathGeometry>(geometry);
    if (!g) return -1;
    Noesis::PathFigureCollection* figures = g->GetFigures();
...
extern "C" void* dm_noesis_path_figure_create(void) {
...
extern "C" bool dm_noesis_path_figure_set_start_point(void* figure, float x, float y) {
    auto* f = cast<Noesis::PathFigure>(figure);
    if (!f) return false;
...
extern "C" bool dm_noesis_path_figure_get_start_point(void* figure, float out[2]) {
    auto* f = cast<Noesis::PathFigure>(figure);
...
extern "C" bool dm_noesis_path_figure_set_is_closed(void* figure, bool is_closed) {
    auto* f = cast<Noesis::PathFigure>(figure);
    if (!f) return false;
...
extern "C" bool dm_noesis_path_figure_set_is_filled(void* figure, bool is_filled) {
    auto* f = cast<Noesis::PathFigure>(figure);
    if (!f) return false;
...
extern "C" int32_t dm_noesis_path_figure_get_is_closed(void* figure) {
    auto* f = cast<Noesis::PathFigure>(figure);
    if (!f) return -1;
    return f->GetIsClosed() ? 1 : 0;
}

extern "C" int32_t dm_noesis_path_figure_get_is_filled(void* figure) {
    auto* f = cast<Noesis::PathFigure>(figure);
    if (!f) return -1;
    return f->GetIsFilled() ? 1 : 0;
}

extern "C" int32_t dm_noesis_path_figure_add_segment(void* figure, void* segment) {
    auto* f = cast<Noesis::PathFigure>(figure);
...
extern "C" int32_t dm_noesis_path_figure_segment_count(void* figure) {
    auto* f = cast<Noesis::PathFigure>(figure);
    if (!f) return -1;
    Noesis::PathSegmentCollection* segments = f->GetSegments();
...
extern "C" void* dm_noesis_line_segment_create(float x, float y) {
    Noesis::Ptr<Noesis::LineSegment> s = *new Noesis::LineSegment(Noesis::Point(x, y), true);
    return handout(s.GetPtr());
}

extern "C" bool dm_noesis_line_segment_get_point(void* segment, float out[2]) {
...
extern "C" void* dm_noesis_bezier_segment_create(float x1, float y1, float x2, float y2, float x3,
                                                 float y3) {
...
extern "C" bool dm_noesis_bezier_segment_get(void* segment, float out[6]) {
...
extern "C" void* dm_noesis_quadratic_bezier_segment_create(float x1, float y1, float x2, float y2) {
    Noesis::Ptr<Noesis::QuadraticBezierSegment> s =
        *new Noesis::QuadraticBezierSegment(Noesis::Point(x1, y1), Noesis::Point(x2, y2), true);
    return handout(s.GetPtr());
}

extern "C" bool dm_noesis_quadratic_bezier_segment_get(void* segment, float out[4]) {
...
extern "C" void* dm_noesis_arc_segment_create(float x, float y, float width, float height,
...
extern "C" bool dm_noesis_arc_segment_get(void* segment, float out_point[2], float out_size[2],
...
extern "C" void* dm_noesis_poly_line_segment_create(const float* points, uint32_t num_points) {
...
extern "C" void* dm_noesis_poly_bezier_segment_create(const float* points, uint32_t num_points) {
    std::vector<Noesis::Point> pts = make_points(points, num_points);
...
extern "C" void* dm_noesis_poly_quadratic_bezier_segment_create(const float* points,
                                                                uint32_t num_points) {
    std::vector<Noesis::Point> pts = make_points(points, num_points);
...
extern "C" int32_t dm_noesis_poly_segment_point_count(void* segment) {
    Noesis::PointCollection* pts = poly_points(segment);
    if (!pts) return cast<Noesis::PathSegment>(segment) ? 0 : -1;
    return pts->Count();
}

extern "C" bool dm_noesis_poly_segment_get_point(void* segment, uint32_t index, float out[2]) {
    Noesis::PointCollection* pts = poly_points(segment);
...
extern "C" void* dm_noesis_ellipse_geometry_create(float cx, float cy, float rx, float ry) {
    Noesis::Ptr<Noesis::EllipseGeometry> g =
        *new Noesis::EllipseGeometry(Noesis::Point(cx, cy), rx, ry);
    return handout(g.GetPtr());
}

extern "C" bool dm_noesis_ellipse_geometry_get(void* geometry, float out[4]) {
...
extern "C" void* dm_noesis_rectangle_geometry_create(float x, float y, float width, float height,
                                                     float rx, float ry) {
...
extern "C" bool dm_noesis_rectangle_geometry_get(void* geometry, float out_rect[4],
                                                 float out_radii[2]) {
...
extern "C" void* dm_noesis_line_geometry_create(float x1, float y1, float x2, float y2) {
    Noesis::Ptr<Noesis::LineGeometry> g =
        *new Noesis::LineGeometry(Noesis::Point(x1, y1), Noesis::Point(x2, y2));
    return handout(g.GetPtr());
}

extern "C" bool dm_noesis_line_geometry_get(void* geometry, float out[4]) {
...
extern "C" void* dm_noesis_combined_geometry_create(int32_t mode, void* geometry1,
                                                    void* geometry2) {
...
extern "C" bool dm_noesis_combined_geometry_set_geometry1(void* geometry, void* g1) {
...
extern "C" bool dm_noesis_combined_geometry_set_geometry2(void* geometry, void* g2) {
    auto* g = cast<Noesis::CombinedGeometry>(geometry);
    if (!g) return false;
...
extern "C" void* dm_noesis_combined_geometry_get_geometry1(void* geometry) {
    auto* g = cast<Noesis::CombinedGeometry>(geometry);
    if (!g) return nullptr;
    return g->GetGeometry1();
}

extern "C" void* dm_noesis_combined_geometry_get_geometry2(void* geometry) {
    auto* g = cast<Noesis::CombinedGeometry>(geometry);
    if (!g) return nullptr;
    return g->GetGeometry2();
}

extern "C" bool dm_noesis_combined_geometry_set_mode(void* geometry, int32_t mode) {
    auto* g = cast<Noesis::CombinedGeometry>(geometry);
    if (!g) return false;
...
extern "C" int32_t dm_noesis_combined_geometry_get_mode(void* geometry) {
    auto* g = cast<Noesis::CombinedGeometry>(geometry);
    if (!g) return -1;
...
extern "C" void* dm_noesis_geometry_group_create(void) {
...
extern "C" bool dm_noesis_geometry_group_set_fill_rule(void* geometry, int32_t rule) {
...
extern "C" int32_t dm_noesis_geometry_group_get_fill_rule(void* geometry) {
    auto* g = cast<Noesis::GeometryGroup>(geometry);
    if (!g) return -1;
    return static_cast<int32_t>(g->GetFillRule());
}

extern "C" int32_t dm_noesis_geometry_group_add_child(void* geometry, void* child) {
    auto* g = cast<Noesis::GeometryGroup>(geometry);
...
extern "C" int32_t dm_noesis_geometry_group_child_count(void* geometry) {
    auto* g = cast<Noesis::GeometryGroup>(geometry);
    if (!g) return -1;
    Noesis::GeometryCollection* children = g->GetChildren();
